...
<body>
	<div class="contain">
		<div class="box">
			...
			<form method="post">
			<input type="submit" name="choice_board_delete_button" value="선택삭제" />
			<div class="board-list-box">
				...
				<c:forEach var="n" items="${list}">
					<tr>
						...
						<td class="title"><a href="/admin/board/detail?board_id=${n.id}"
						...
						<td class="hit"><input type="checkbox" class="" name="choice_board" value="${n.id}" /></td>
					</tr>
				</c:forEach>
			...
			<div class="reg-box">
				<form>
					<a class="border-reg" href="/admin/board/reg">게시물
						작성하기</a>
				</form>
			</div>
		</div>
