...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/admin/index/index.css" />
    <title>CRUD</title>
  </head>
  <body>
    <div class="contain">
      <div class="box">
        ...
        <h3>${userId}<strong>관리자님</strong> 환영합니다.</h3>
        <div class="board-list-box">
          <a href="/admin/board/list" class="board-list-link">
          	게시판 리스트
          </a>
        </div>
      </div>
