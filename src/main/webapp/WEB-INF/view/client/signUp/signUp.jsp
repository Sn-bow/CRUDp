...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/client/signUp/signUp.css" />
    <title>CRUD</title>
  </head>
  <body>
    <div class="contain">
      <div class="box">
        <div class="link-box">
          <span class="home-link-span">
            <a class="link" href="/client/signIn">LOGIN</a>
          </span>
        ...
        <form class="form-box" action="" method="post">
          ...
          <div class="form-item-box">
            ...
            <div class="err-box phoneErr">err message</div>
          </div>
          <div class="form-item-box">
            <div class="input-box">
              <input type="date" name="birth" class="input date" />
            </div>
            <div class="err-box dateErr">err message</div>
          </div>
          <div class="form-submit-box">
            <div class="submit-box">
              <input
                type="submit"
                class="input signUpSubmit"
                value="회원가입"
                disabled
              />
            </div>
    ...
    <script src="${pageContext.request.contextPath}/client/signUp/signUp.js" type="text/javascript"></script>
  </body>
</html>
